...
export default function Branches() {
  ...
  const onRowClick = (b) => {
    // Placeholder for branch detail page/navigation
  };
  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow text-gray-800">
      <div className="flex items-center justify-between mb-4">
        ...
        <a href="?page=CreateBranch" className="rounded-md bg-blue-500 hover:bg-blue-400 text-white px-3 py-1.5 text-sm font-semibold">Create Branch</a>
      </div>
