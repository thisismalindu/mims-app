  ...
  return (
    <div className=" px-6 py-12 lg:px-8">
      ...
      <form className="w=full max-w-3xl mt-10 " onSubmit={handleSubmit}>
        {
          [
            { label: "Branch Name", id: "branchname", name: "branch_name", type: "text", required: true },
            { label: "Location / Address", id: "address", name: "address", type: "text", required: true },
            { label: "Contact Number", id: "phone", name: "phone_number", type: "tel", required: true },
            { label: "Email (optional)", id: "email", name: "email", type: "email", required: false },
            { label: "Opening Hours (optional)", id: "hours", name: "opening_hours", type: "text", required: false },
          ]
            .map(field => (
